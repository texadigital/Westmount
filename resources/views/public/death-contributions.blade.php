        ...
        <div class="absolute inset-0 flex items-center">
            <div class="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8">
                <div class="text-center">
                    <h1 class="text-4xl md:text-6xl font-bold mb-6" style="text-shadow: 0 2px 6px rgba(0,0,0,.6)">Contributions Décès</h1>
                    <p class="text-xl md:text-2xl max-w-3xl mx-auto" style="text-shadow: 0 1px 4px rgba(0,0,0,.6)">Solidarité et soutien en cas de décès d'un membre</p>
                </div>
            </div>
        </div>
    </section>
