...
<div class="min-h-screen bg-gray-50">
    ...
    <section class="relative text-white">
        <div class="h-[320px] md:h-[420px] w-full">
            <img src="https://images.unsplash.com/photo-1496302662116-35cc4f36df92?auto=format&fit=crop&w=1920&q=80" alt="Questions fréquentes" class="w-full h-full object-cover" />
        </div>
        <div class="absolute inset-0 bg-gradient-to-r from-primary/80 to-black/60"></div>
        <div class="absolute inset-0 flex items-center">
            <div class="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8">
                <div class="text-center">
                    <h1 class="text-4xl md:text-6xl font-bold mb-6" style="text-shadow: 0 2px 6px rgba(0,0,0,.6)">Questions Fréquentes</h1>
                    <p class="text-xl md:text-2xl max-w-3xl mx-auto" style="text-shadow: 0 1px 4px rgba(0,0,0,.6)">Trouvez les réponses à vos questions</p>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-lg shadow-md">
                        ...
                        <div id="faq2-content" class="hidden px-6 pb-4">
                            <p class="text-gray-600">
                                Les frais d'adhésion sont de 50$ CAD pour tous les types de membres. Les contributions mensuelles varient Contribution selon le type de membre décédé. : 10$ pour les membres réguliers et associations, 2$ pour les membres juniors et seniors.
                            </p>
                        </div>
                    </div>
